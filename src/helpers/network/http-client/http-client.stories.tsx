...
export const PostContact: Story = {
    render: (args) => {
        ...
        const client = useMemo(
            () => new HTTPClient(args.apiAddress),
            [args.apiAddress],
        );
            ...
            <FormProvider controller={controller}>
                ...
                <div>
                    <FieldConsumer field="newPublicKey">
                        {({ value, setValue }) => (
                            <textarea
                                placeholder="New JWK public key"
                                value={value}
                                onChange={(e) => setValue(e.target.value)}
                            />
                        )}
                ...
                <div>
                    <FieldConsumer field="newPublicSign">
                        {({ value, setValue }) => (
                            <textarea
                                placeholder="New JWK public sign"
                                value={value}
                                onChange={(e) => setValue(e.target.value)}
                            />
                        )}
