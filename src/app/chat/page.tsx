...
export default function ChatPage() {
    ...
    const sendMessage = useCallback((text: string) => {
        if(!chatInfo || network.type !== "READY" || storage.type !== "READY") return;

        const connection = storage.connections.getConnection(chatInfo.connectionID);
    ...
    useEffect(() => {
        ...
        const sub = storage.chats.subscribe(() => setChatInfo(storage.chats.getChat(chatID)))
